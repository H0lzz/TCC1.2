...
\begin{itemize}
    ...
    \item a implementação de um modo \textit{offline-first}, com armazenamento local e sincronização posterior dos dados, funcionalidade identificada como desejável durante o \textit{Lean Inception}, mas classificada fora do escopo do MVP em razão de seu esforço técnico e da baixa prioridade diante do público universitário do produto, que tende a ter acesso mais estável à internet;
