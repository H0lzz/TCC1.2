...
Diante disso, em estudos realizados com estudantes, o pilar de Gestão do Tempo se mostrou como um forte fator no desempenho acadêmico \cite{zhou_2016}. Portanto, a eficácia na gestão do tempo está diretamente ligada ao desempenho.
...
No entanto, a eficácia da gamificação deve ser analisada com responsabilidade, pois seu impacto se manifesta primariamente na motivação, e normalmente não trazem ganhos na aprendizagem em si.
...
Contudo, essa motivação não garante um aumento nos resultados destes estudos.
...
Dessa maneira, o Aprovado apresenta limitações ao ser comparado ao escopo do aplicativo proposto neste trabalho.
...
Ele não oferece recursos estudo ativo, como os flashcards com repetição espaçada, o que é uma metodologia ideal para a memorização e recuperação de conteúdo.
...
De outra maneira, o StudyTok, mostrado na Figura~\ref{fig:studytok}, se posiciona como uma plataforma de aprendizagem dinâmica, utilizando a Inteligência Artificial (IA) para transformar materiais de estudo em componentes interativos dentro da aplicação.
Seu principal valor é a funcionalidade de geração de material de estudo, ou seja, o usuário pode enviar imagens, PDFs, PowerPoints e vídeos para a IA gerar questionários e flashcards.
Essa capacidade de conversão de conteúdo em flashcards está diretamente ligada ao pilar de prática de recuperação ativa, permitindo que a IA crie os recursos necessários para a repetição espaçada ao invés do próprio aluno, otimizando o tempo que seria gasto na criação manual \cite{studytok_2026}.

Além disso, o aplicativo possui a gamificação através de sequências diárias, placares de líderes e um sistema de recompensa por pontos a fim de manter a motivação. Portanto, em comparação com este trabalho, o StudyTok não possui os valores de gestão do tempo e controle da saúde mental que este trabalho pretende implementar \cite{studytok_2026}.
