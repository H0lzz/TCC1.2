...
O diferencial está em combinar a eficácia da repetição espaçada com uma ferramenta de cronômetro Pomodoro (gestão do tempo), elementos de gamificação e \textit{check-ins} de humor, oferecendo assim uma solução mais coesa e adaptada às demandas do estudante.
...
\section{Gamificação (\textit{Progress Bars})}

A gamificação será utilizada para tornar o processo de estudos com o aplicativo mais atraente.
Em um estudo focado nesse sentido, \citeonline{vandenbroek_2026} investigaram se o \textit{feedback} gamificado em práticas adaptativas de recuperação, utilizando pontos e barras de progresso, poderia tornar a estratégia mais atrativa para os estudantes.
...
Dentre os elementos gamificados, as barras de progresso são importantes, pois fornecem aos usuários um \textit{feedback} visual sobre o seu avanço em direção a uma meta.
...
Um estudo, conduzido por \citeonline{hsu_2026}, por exemplo, desenvolveu um sistema de jogo \textit{online} e explorou os efeitos da aprendizagem baseada em jogos, juntamente com diferentes métodos de orientação do pensamento, no pensamento computacional e na autoeficácia de estudantes do ensino fundamental.
