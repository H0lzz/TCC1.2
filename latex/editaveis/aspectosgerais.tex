...
Seu principal valor é a funcionalidade de geração de material de estudo, em que o usuário envia imagens, PDFs, PowerPoints e vídeos para o aplicativo e, em seguida a IA gera questionários e flashcards.
...
Enquanto o Aprovado se restringe ao registro e à estatística da Gestão do Tempo e o StudyTok se destaca na geração de flashcards por IA e gamificação, o aplicativo proposto visa combinar esses valores com o controle de bem estar a fim de trazer um produto centralizado e desfragmentado.
O diferencial está em combinar a eficácia da repetição espaçada com uma ferramenta de cronômetro Pomodoro (gestão do tempo), elementos de gamificação e check-ins de humor, oferecendo assim uma solução mais coesa e adaptada às demandas do estudante.

\flushbottom
\clearpage
\section{Heurísticas de Nielsen}

A boa usabilidade de um sistema é construída a partir de um conjunto de regras reconhecidas no campo da engenharia de softaware como as heurísticas de Nielsen.
...
Adicionalmente, o projeto respeita a Lei Geral de Proteção de Dados (LGPD) \cite{brasil2018lgpd}, garantindo segurança, privacidade e transparência no tratamento das informações dos usuários.
...
Diante disso, o ARE sempre calcula um intervalo de revisão adequado para o usuário conforme a dificuldade, apresentando o conteúdo no momento em que estaria sendo esquecido, o que é mais eficáz comparado com a repetição excessiva.
A implementação dessa metodologia ganhou populariedade em aplicações móveis, pois a portabilidade dos smartphones eliminam os problemas de tempo e local, permitindo que estudantes estudem quando e onde quiserem.
...
Os algoritmos de repetição espaçada se classificam como uniforme ou dinâmico, este sendo mais eficiente já que calcular o tamanho ideal do intervalo da repetição conforme o feedback.
...
Essa abordagem se alinha com o valor de gestão do tempo deste trabalho, proporcionando ao estudante uma metodologia eficáz para ajudar no planejamento e execução das tarefas.
...
Dessa forma, será implementado o Pomodoro com ciclos customizáveis, permitindo que o usuário ajuste os tempos de foco e pausa de acordo com sua preferência.

\section{Gamificação (Progress Bars)}

A gamificação será utilizada para tornar o processo de estudos com o aplicativo mais atraente.
Em um estudo focado nesse sentido, \citeonline{vandenbroek_2026} investigaram se o feedback gamificado em práticas adaptativas de recuperação, utilizando pontos e barras de progresso, poderia tornar a estratégia mais atrativa para os estudantes.
Os resultados revelaram que esses elementos gamificados melhoraram a motivação dos participantes, mas não resultaram em um aumento estatisticamente significativo na aprendizagem em si.
...
Elas exploram a psicologia onde a percepção de já ter iniciado e progredido em uma tarefa aumenta a motivação para completar o resto.
No contexto de um aplicativo de estudos, uma barra de progresso visual ajuda o aluno a converter metas em marcos reais.

Apesar da ressalva de \citeonline{vandenbroek_2026} sobre a não melhoria direta do aprendizado por pontos e barras de progresso, a gamificação demonstra ser um forte pilar para o engajamento e motivação.
...
Isso sugere que, embora a barra de progresso sozinha não ensine o conteúdo, sua integração com metodologias pode criar um ambiente motivacional para que o estudante mantenha o engajamento, superando a taxa de abandono.
...
Dessa forma, a integração de check-ins de bem-estar e a análise dos gráficos gerados transformam o aplicativo em um agente de suporte à SRL.
