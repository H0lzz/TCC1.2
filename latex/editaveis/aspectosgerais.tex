...
Ampliando a análise para além de aplicativos de nicho voltados à rotina de estudos, também foram considerados dois \textit{softwares} amplamente adotados que representam, isoladamente, dois dos pilares deste trabalho: o Anki e o Habitica.

O Anki é a referência mais consolidada em repetição espaçada, oferecendo um sistema de \textit{flashcards} com algoritmo adaptativo que agenda a revisão de cada cartão "para quando o usuário está mais propenso a esquecer a informação" \cite{anki_2026}.
Apesar de ser o padrão de mercado nesse pilar específico, o Anki não possui nenhum recurso nativo de gestão de tempo (como um cronômetro Pomodoro), de gamificação ou de monitoramento de bem-estar, concentrando-se exclusivamente na otimização da memorização \cite{anki_2026}.

Já o Habitica adota a abordagem oposta: é uma plataforma de gamificação de hábitos e tarefas no formato de um jogo de RPG, na qual o usuário ganha experiência, ouro e itens ao concluir tarefas do cotidiano, além de poder participar de grupos (\textit{guilds}) e missões em equipe \cite{habitica_2026}.
...
Portanto, o aplicativo proposto para este trabalho se diferencia dos concorrentes ao buscar uma integração completa de todos os valores mencionados anteriormente, em vez de se aprofundar isoladamente em um único pilar.
Enquanto o Aprovado se restringe ao registro e à estatística da gestão do tempo, o StudyTok se destaca na geração de \textit{flashcards} por IA e gamificação, o Anki é o padrão de excelência isolado em repetição espaçada e o Habitica é o padrão de excelência isolado em gamificação de hábitos, nenhum dos quatro combina esses pilares com o controle de bem-estar do estudante.
